...
export class CanvasPainterComponent implements OnInit {
  ...
  private setPointFromEvent(point, e): void {
    if (this._isTouch) {
  ...
  private _downHandler: any = (e) => { this.mousedown(); };
  private _moveHandler: any = (e) => { this.paint(e); };
  private _upHandler: any = (e) => { this.mouseup() };
  private _paintStartHandler: any = (e) => { this.startTmpImage(e) };
  private _paintEndHandler: any = (e) => { this.copyTmpImage() };
  private _enterHandler: any = (e) => { this.mouseenter(e) }; 
  private _leaveHandler: any = (e) => { this.mouseleave(e) };
